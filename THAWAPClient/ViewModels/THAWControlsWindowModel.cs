...
namespace THAWAPClient.ViewModels
{
    public partial class THAWControlsWindowModel : Archipelago.Core.AvaloniaGUI.ViewModels.ViewModelBase, INotifyPropertyChanged
    {
        ...
        public THAWControlsWindowModel()
        {
